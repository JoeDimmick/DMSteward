...
const validationSchema = yup.object({
    ...
    str_mod: yup.number().required(),
    dex: yup.number().required(),
    dex_mod: yup.number().required(),
    con: yup.number().required(),
    con_mod: yup.number().required(),
    int: yup.number().required(),
    int_mod: yup.number().required(),
    wis: yup.number().required(),
    wis_mod: yup.number().required(),
    cha: yup.number().required(),
    cha_mod: yup.number().required(),
