                ...
                <section id="top">
                    ...
                    <div className="block">
                        <div className="field">
                            ...
                            <div className="control">
                                <input className="input-sm" type="text" name="armor_class"
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input className="input-sm" type="text" name="hit_points" value={values.hit_points}
                                       onChange={handleChange}/>
                    ...
                    <div className="block">
                        <div className="stat-block">
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="str" value={values.str}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="str_mod" value={values.str_mod}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="dex" value={values.dex}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="dex_mod" value={values.dex_mod}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="con" value={values.con}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="con_mod" value={values.con_mod}
                                           onChange={handleChange}/>
                        ...
                        <div className="stat-block">
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="int" value={values.int}
                                           onChange={handleChange}/>
                                    <VHelp message={errors.int}/>
                                </div>
                            </div>
                            <div className="field">
                                <label htmlFor="int_mod">INT Mod</label>
                                <div className="control">
                                    <input className="input-sm" type="text" name="int_mod" value={values.int_mod}
                                           onChange={handleChange}/>
                                    <VHelp message={errors.int_mod}/>
                                </div>
                            </div>
                            <div className="field">
                                <label htmlFor="wis">WIS</label>
                                <div className="control">
                                    <input className="input-sm" type="text" name="wis" value={values.wis}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="wis_mod" value={values.wis_mod}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="cha" value={values.cha}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="cha_mod" value={values.cha_mod}
                                           onChange={handleChange}/>
                    ...
                    <div className="block">
                        <div className="stat-block">
                            <div className="field">
                                ...
                                <div className="control">
                                    <input type="text" name="saving_throws" value={values.saving_throws}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input type="text" name="languages" value={values.languages}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input type="text" name="challenge" value={values.challenge}
                                           onChange={handleChange}/>
                    ...
                    <div className="block">
                        <div className="stat-block">
                            <div className="field">
                                ...
                                <div className="control">
                                    <input className="input-sm" type="text" name="speed" value={values.speed}
                                           onChange={handleChange}/>
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    <input type="text" name="legendary_actions" value={values.legendary_actions}
                                           onChange={handleChange}/>
