...
connect("mongodb://localhost:27017/DMSteward")
...
app.use(function (req, res, next){
    res.render('layout', {content: 'error', err: createError(404), title: "DMSteward"})
})

app.use(function (err, req, res, next){
    res.status(err.status || 500)
    res.render('layout', {content: 'error', title: "DMSteward", err: err })
})
